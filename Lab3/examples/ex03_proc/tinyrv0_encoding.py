...
[
 ...
 # [ "lw     rd, i_imm(rs1)",   0b00000000000000000111000001111111, 0b00000000000000000010000000000011 ], # I-type
  ...
  [ "slli   rd, rs1, shamt",   0b11111110000000000111000001111111, 0b00000000000000000001000000010011 ], # R-type
  [ "srl    rd, rs1, rs2",     0b11111110000000000111000001111111, 0b00000000000000000101000000110011 ], # R-type
  [ "srli   rd, rs1, shamt",   0b11111110000000000111000001111111, 0b00000000000000000101000000010011 ], # R-type
  [ "sra    rd, rs1, rs2",     0b11111110000000000111000001111111, 0b01000000000000000101000000110011 ], # R-type
  [ "srai   rd, rs1, shamt",   0b11111110000000000111000001111111, 0b01000000000000000101000000010011 ], # R-type
 # [ "sll    rd, rs1, rs2",     0b11111110000000000111000001111111, 0b00000000000000000001000000110011 ], # R-type
 # [ "srl    rd, rs1, rs2",     0b11111110000000000111000001111111, 0b00000000000000000101000000110011 ], # R-type
  # Arithmetic
...
tinyrv0_field_slice_u_imm  = slice( 12, 32 )

tinyrv0_field_slice_j_imm0 = slice( 21, 31 )
tinyrv0_field_slice_j_imm1 = slice( 20, 21 )
tinyrv0_field_slice_j_imm2 = slice( 12, 20 )
tinyrv0_field_slice_j_imm3 = slice( 31, 32 )
...
def assemble_field_u_imm( bits, sym, pc, field_str ):
  ...
  assert imm < (1 << 20)
  bits[ tinyrv0_field_slice_u_imm ] = imm

def disassemble_field_u_imm( bits ):
  return "0x{:0>5x}".format( bits[ tinyrv0_field_slice_u_imm ].uint() )
...
def assemble_field_j_imm( bits, sym, pc, field_str ):
  ...
  if field_str in sym: #.has_key( field_str ):
    # notice that we encode the branch target address (a lable) relative
    # to current PC
  ...
  bits[ tinyrv0_field_slice_j_imm0 ] = imm[1:11]
  bits[ tinyrv0_field_slice_j_imm1 ] = imm[11:12]
  bits[ tinyrv0_field_slice_j_imm2 ] = imm[12:20]
  bits[ tinyrv0_field_slice_j_imm3 ] = imm[20:21]
...
class TinyRV0Inst :
  ...
  def name( self ):
    if self.bits == 0b00000000000000000000000000010011:
      ...
      if   self.funct7 == 0b0000000:
        ...
        elif self.funct3 == 0b010: return "slt"
        elif self.funct3 == 0b011: return "sltu"
        elif self.funct3 == 0b100: return "xor"
        elif self.funct3 == 0b101: return "srl"
        elif self.funct3 == 0b110: return "or"
        elif self.funct3 == 0b111: return "and"
      elif self.funct7 == 0b0100000:
        if   self.funct3 == 0b000: return "sub"
        elif self.funct3 == 0b101: return "sra"
      elif self.funct7 == 0b0000001:
        if   self.funct3 == 0b000: return "mul"
    elif self.opcode == 0b0010011:
      if   self.funct3 == 0b000: return "addi"     
      elif self.funct3 == 0b010: return "slti"
      elif self.funct3 == 0b011: return "sltiu"
      elif self.funct3 == 0b100: return "xori"
      elif self.funct3 == 0b110: return "ori"
      elif self.funct3 == 0b111: return "andi"
      elif self.funct3 == 0b001: return "slli"
      elif self.funct3 == 0b101:
        if   self.funct7 == 0b0000000: return "srli"
        elif self.funct7 == 0b0100000: return "srai"
    elif self.opcode == 0b0100011:
      if   self.funct3 == 0b000: return "sb"
      elif self.funct3 == 0b001: return "sh"
      elif self.funct3 == 0b010: return "sw"

    elif self.opcode == 0b0000011:
      if   self.funct3 == 0b000: return "lb"
      elif self.funct3 == 0b001: return "lh"
      elif self.funct3 == 0b010: return "lw"   
      elif self.funct3 == 0b100: return "lbu"
      elif self.funct3 == 0b101: return "lhu"

    elif self.opcode == 0b1100011:
      if   self.funct3 == 0b000: return "beq"
      elif self.funct3 == 0b001: return "bne"      
      elif self.funct3 == 0b100: return "blt"
      elif self.funct3 == 0b101: return "bge"
      elif self.funct3 == 0b110: return "bltu"
      elif self.funct3 == 0b111: return "bgeu"
    elif self.opcode == 0b0110111: return "lui" 
    elif self.opcode == 0b0010111: return "auipc"
    elif self.opcode == 0b1101111: return "jal"
    elif self.opcode == 0b1100111: return "jalr"
  ...
  @property
  def u_imm( self ):
    return concat( self.bits[ tinyrv0_field_slice_u_imm ], Bits(12,0) )
  
  @property
  def j_imm( self ):
    imm = Bits( 21, 0 )
    imm[1:11]  = self.bits[ tinyrv0_field_slice_j_imm0 ]
    imm[11:12] = self.bits[ tinyrv0_field_slice_j_imm1 ]
    imm[12:20] = self.bits[ tinyrv0_field_slice_j_imm2 ]
    imm[20:21] = self.bits[ tinyrv0_field_slice_j_imm3 ]
    return imm
